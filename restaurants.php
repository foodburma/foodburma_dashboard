      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Restaurants</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Restaurants</h6>
        </nav>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <h6>Restaurants table</h6>
                    <a href="add-restaurant.php" class="btn btn-sm btn-success"><i class="fas fa-plus"></i></a>
                    </div>
