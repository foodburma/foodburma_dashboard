                ...
                <div class="card mb-4">
                    ...
                    <div class="table-responsive p-0">
                          <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">Thumbnail</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">Details</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="white-space: normal;">
                                        <p class="text-xs font-weight-bold mb-0">This is some placeholder content the Home tab's</p>
                                        <p class="text-xs text-secondary mb-0">Clicking another tab will toggle the visibility of this one for the next. </p>
                                    </td>
