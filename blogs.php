        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <h6>Blogs table</h6>
                    <a href="add-blog.php" class="btn btn-sm btn-success"><i class="fas fa-plus"></i></a>
                    </div>
                          ...
                          <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Create Date</th>
